...
> **Git Hooks Note**: Pre-commit hooks enforce passing tests. When writing failing tests (RED phase), use `WINGMAN_SKIP_HOOKS=1 git commit` to bypass temporarily.
...
WINGMAN_SKIP_HOOKS=1 git commit -m "WIP: failing test for new feature"
...
echo $WINGMAN_SKIP_HOOKS  # Should show "1"

# Set for single command
WINGMAN_SKIP_HOOKS=1 git commit -m "message"

# Check shell (different syntax for different shells)
# bash/zsh: export WINGMAN_SKIP_HOOKS=1
# fish: set -x WINGMAN_SKIP_HOOKS 1
```
...
*Generated by wingman git-hooks framework*
