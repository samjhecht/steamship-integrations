...
**Via Skill**: Use `/wingman:create-issue` or the `create-new-issue` skill
...
**Check**: Which phase of `.wingman/ROADMAP.md` does this support?
...
1. Creates optional plan file in `.wingman/plans/` (if architecture context needed)
...
6. **Estimate effort** - Use `governanceContext.estimatedEffort` for planning
