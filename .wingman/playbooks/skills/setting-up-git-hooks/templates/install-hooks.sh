#!/bin/bash
# install-hooks.sh - Install version-controlled git hooks from .wingman/config/git-hooks/
# Generated by wingman git-hooks framework (Pattern B)
#
# Usage:
#   ./scripts/install-hooks.sh
#
# This script creates symlinks from .git/hooks/ to .wingman/config/git-hooks/
...
# Configuration
# =============================================================================
HOOKS_SOURCE_DIR=".wingman/config/git-hooks"
...
if [ ! -d "$HOOKS_SOURCE_DIR" ]; then
    ...
    log_error ""
    log_error "Run /wingman:setup-git-hooks with Pattern B to create this structure."
    exit 1
fi
...
for hook in "${HOOKS[@]}"; do
    ...
    if [ -f "$source" ]; then
        ...
        # From .git/hooks/ to .wingman/config/git-hooks/, we need ../../.wingman/config/git-hooks/
        ln -s "../../$source" "$target"
